...
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/HollyGurza/ProxmoxVE/localmain/tools/copy-data//home-assistant-core-copy-data-home-assistant-container.sh)"
